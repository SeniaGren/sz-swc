...
layui.use(['jquery', 'table', 'form', 'admin', 'layer'], function () {
    ...
    table.render({
        ...
        cols: [[
            ...
            {type: 'checkbox'},
            {field: 'serviceid', title: 'ID', sort: true},
            {field: 'servicename', title: 'service页面名称'},
            {field: 'servicecontent', title: 'service页面内容'},
            {field: 'serviceicon', title: 'service图标'}
        ]]
    });
    ...
    var active = {
        ...
        getCheckData: function () {
            //批量删除的功能
            //先获取被选中的数据
            var status = table.checkStatus('serviceList');
