...
layui.use(['jquery', 'table', 'form', 'admin', 'layer'], function () {
    ...
    table.render({
        ...
        cols: [[
            {type: 'checkbox'},
            {field: 'aboutid', title: 'ID', sort: true},
            {field: 'aboutname', title: 'about页面名称'},
            {field: 'aboutcontent', title: 'about页面内容'}
        ]]
    });
    ...
    var active = {
        ...
        getCheckData: function () {
            //批量删除的功能
            //先获取被选中的数据
            var status = table.checkStatus('aboutList');
