...
layui.use(['jquery', 'table', 'form', 'admin', 'layer'], function () {
    ...
    table.render({
        ...
        cols: [[
            ...
            {type: 'checkbox'},
            {field: 'portfolioid', title: 'ID', sort: true},
            {field: 'portfolioname', title: '负责人名称'},
            {field: 'portfolioimgs', title: '负责人照片地址'},
            {field: 'portfoliooccupation', title: '负责人职位'}
        ]]
    });
    ...
    var active = {
        ...
        getCheckData: function () {
            //批量删除的功能
            //先获取被选中的数据
            var status = table.checkStatus('portfolioList');
