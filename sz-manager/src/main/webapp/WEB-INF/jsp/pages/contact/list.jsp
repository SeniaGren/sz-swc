...
<head>
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/static/js/contactlist.js" charset="utf-8"></script>
...
<table class="layui-hide" id="contactList" ></table>
