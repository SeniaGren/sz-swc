...
<div class="weadmin-body">
    <form class="layui-form" action="/index/update">
        <div class="layui-form-item" hidden>
            <label class="layui-form-label">indexid</label>
            <div class="layui-input-block">
                <input type="text" name="indexid" id="indexid"  autocomplete="off" class="layui-input">
            </div>
        </div>

        <div class="layui-form-item">
            <label class="layui-form-label">indexcontent</label>
            <div class="layui-input-block">
                <input type="text" name="indexcontent" id="indexcontent" autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">indexname</label>
            <div class="layui-input-block">
                <textarea class="layui-textarea" name="indexname"  id="indexname"></textarea>
            </div>
        </div>
        <div class="layui-form-item">
