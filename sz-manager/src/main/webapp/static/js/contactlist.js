...
layui.use(['jquery', 'table', 'form', 'admin', 'layer'], function () {
    ...
    table.render({
        ...
        elem: '#contactList',
        // url: '../../items',
        url: '../../tbconnection/select',
        cols: [[
            {type: 'checkbox'},
            {field: 'connectid', title: 'ID', sort: true},
            {field: 'qqnumber', title: 'QQ号码'},
            {field: 'wechatnumber', title: '微信号码'},
            {field: 'weibonumber', title: '微博号码', sort: true},
            {field: 'mailnumber', title: '邮箱地址'},
    ...
    var active = {
        ...
        getCheckData: function () {
            //批量删除的功能
            //先获取被选中的数据
            var status = table.checkStatus('contactList');
        ...
        editCheckData: function () {
            ...
            if (2 > data.length > 0) {
                WeAdminEdit('修改about页面','./edit',data,600,500);
            }else{
